// Axon S3 Blueprint — 3 floating iso planes with right-angle leader lines (PhysicsSpec, SensorGraph, FieldState)
export default function EnergyGraphLayers() {
  return (
    <svg viewBox="0 0 820 310" style={{ width: '100%', maxWidth: 880, display: 'block', margin: '0 auto', fontFamily: "'Space Mono',monospace" }}>
      {/* vertical dashed spine */}
      <line x1="410" y1="50" x2="410" y2="250" stroke="#cfc8b9" strokeWidth="1" strokeDasharray="2 4"/>

      {/* ── LAYER 3 FieldState (bottom) ── */}
